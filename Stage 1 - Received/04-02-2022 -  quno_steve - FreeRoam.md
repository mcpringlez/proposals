...
2) Transparency is a double edged sword. Letting all holders know when a vote is passed is noble, but a minority will still look to take advantage. Erratic staggering of purchases and covert misdirection will discourage opportunistic insiders who plan to list lower than floor to "sell into the sweep". If opportunistic insiders can't properly time when the DAO is spending that proposal's budget, they'll probably get wrecked. The overarching effect will be the price will behave more organically as it did before any proposal was approved, as inside opportunists will be hesitant to try to time the sweep.
